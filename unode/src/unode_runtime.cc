...
int RunScriptWithGlobals(napi_env env,
  ...
  static const char kBootstrapPrelude[] =
      ...
      "  try {"
      "    var __bufmod = __unodeBootstrapRequire('buffer');"
      ...
      "    var __bufExports = (typeof __bufmod === 'object' && __bufmod) ? __bufmod : __unodeBootstrapRequire('buffer');"
  ...
  static const char kPrelude[] =
      ...
      "        try { t.__unode_detached_arraybuffer_marker = 1; } catch (_) {}"
