#ifndef NAPI_V8_UBI_V8_PLATFORM_H_
#define NAPI_V8_UBI_V8_PLATFORM_H_
...
class UbiV8Platform final : public v8::Platform {
 ...
 private:
  ...
  explicit UbiV8Platform(std::unique_ptr<v8::Platform> fallback);
...
#endif  // NAPI_V8_UBI_V8_PLATFORM_H_
