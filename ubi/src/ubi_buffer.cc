...
using ubi::encoding_ids::kEncBase64Url;
using ubi::encoding_ids::kEncBuffer;
using ubi::encoding_ids::kEncHex;
using ubi::encoding_ids::kEncLatin1;
using ubi::encoding_ids::kEncUtf16Le;
using ubi::encoding_ids::kEncUtf8;
...
napi_value BindingCreateUnsafeArrayBuffer(napi_env env, napi_callback_info info) {
  ...
  if (size_double >= kUbiUnsafeArrayBufferAllocCap) {
